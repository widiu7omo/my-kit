...
export const LOGIN_ERRORS: Record<AuthErrorMessage, string> = {
    AUTH_DUPLICATE_SESSION_ID: "You already login.",
    AUTH_INVALID_PASSWORD: "Your password are not correct. Please try again",
    AUTH_INVALID_PROVIDER_ID: "User not found. Please make sure you have registered before.",
    AUTH_INVALID_REQUEST: "Request can't be process. Please try again later.",
    AUTH_INVALID_SESSION_ID: "Session not found. Make sure you have login.",
    AUTH_INVALID_USER_ID: "User not found. Please make sure you have registered before.",
    ...
    UNKNOWN_ERROR: "Unknown Error. Please contact us if you are facing this issue again.",
