...
<AppShell class="bg-white">
            ...
            <Container>
                <nav class="relative z-50 flex justify-between">
                    ...
                    <div class="flex items-center gap-x-5 md:gap-x-8">
                        ...
                        <a class="group !text-white inline-flex items-center justify-center !rounded-full !py-2 !px-4 !text-sm !font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-blue-600 text-white hover:text-slate-100 hover:bg-blue-500 active:bg-blue-800 active:text-blue-100 focus-visible:outline-blue-600"
                           href="/register">
                          <span>
    ...
    <svelte:fragment slot="pageFooter">
        <footer class="bg-slate-50">
            <Container>
                <div class="py-16">
                    <AppBrand class="mx-auto h-10 w-auto"/>
...
<style lang="postcss" global>
    a {
        @apply no-underline py-1 px-2 rounded-token text-gray-500 !important
    }
