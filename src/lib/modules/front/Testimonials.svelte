<script>
    import avatarImage1 from '$lib/assets/images/avatars/avatar-1.png'
    import avatarImage2 from '$lib/assets/images/avatars/avatar-2.png'
    import avatarImage3 from '$lib/assets/images/avatars/avatar-3.png'
    import avatarImage4 from '$lib/assets/images/avatars/avatar-4.png'
    import avatarImage5 from '$lib/assets/images/avatars/avatar-5.png'
...
>
    <Container>
        ...
        >
            {#each testimonials as column,index (index)}
                <li>
                    <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                        {#each column as testimonial,testimonialIndex (testimonialIndex)}
                            <li>
                                <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                                    ...
                                    <blockquote class="relative bg-transparent !border-none">
