<script>
    ...
    import logoLaravel from '$lib/assets/images/logos/laravel.svg'
    import logoMirage from '$lib/assets/images/logos/mirage.svg'
    import logoStatamic from '$lib/assets/images/logos/statamic.svg'
    import logoStaticKit from '$lib/assets/images/logos/statickit.svg'
    import logoTransistor from '$lib/assets/images/logos/transistor.svg'
    import logoTuple from '$lib/assets/images/logos/tuple.svg'
...
<Container class="pt-20 pb-16 text-center lg:pt-32">
    ...
    <div class="mt-10 flex justify-center gap-x-6">
        ...
        <a class="!rounded-full border border-gray-200 flex flex-row items-center !px-4"
    ...
    <div class="mt-36 lg:mt-44">
        ...
        >
            {#each features as group,index (index + "-fet")}
                <li>
                    <ul
                            role="list"
                            class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0"
                    >
                        {#each group as feat,index(index + "-f")}
                            <li class="flex">
                                <img src={feat.logo} alt=""/>
                            </li>
                        {/each}
                    </ul>
                </li>
